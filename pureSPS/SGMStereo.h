...
public:
	...
	void SGMStereo::compute(const IplImage* leftImage,
		const IplImage* rightImage,
		float* disparityImage);

private:
	void initialize(const IplImage* leftImage, const IplImage* rightImage);
	void setImageSize(const IplImage* leftImage, const IplImage* rightImage); 
	void allocateDataBuffer();
	void freeDataBuffer();
	void computeCostImage(const IplImage* leftImage, const IplImage* rightImage);
	void convertToGrayscale(const IplImage* leftImage,
		const IplImage* rightImage,
